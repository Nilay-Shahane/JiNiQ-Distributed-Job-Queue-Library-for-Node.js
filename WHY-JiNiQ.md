...
<sub>Application → JiNiQ → Redis → Workers. That's the whole picture. Everything below explains *why* it has to look like this.</sub>
...
1. [Your application works... until it grows](#your-application-works-until-it-grows)
2. [Level 0 – The Synchronous World](#level-0-the-synchronous-world)
3. [Level 1 – Moving Work Into the Background](#level-1-moving-work-into-the-background)
4. [Level 2 – The Problem of Losing Jobs](#level-2-the-problem-of-losing-jobs)
5. [Level 3 – Jobs Become Data](#level-3-jobs-become-data)
6. [Level 4 – Why Not Just Use a Database?](#level-4-why-not-just-use-a-database)
7. [Level 5 – Why Redis?](#level-5-why-redis)
8. [Level 6 – Why Not Build a Queue Yourself?](#level-6-why-not-build-a-queue-yourself)
9. [Level 7 – JiNiQ](#level-7-jiniq)
10. [The JiNiQ Philosophy](#the-jiniq-philosophy)
